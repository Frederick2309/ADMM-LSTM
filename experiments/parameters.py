...
example_parameter_dictionary: Dict[str, Dict[str, Dict[str, float]]] = {
    ...
    'GEFCOM2012': {
        'rho': {
            'i': 1, 'f': 1, 'g': 1, 'o': 1, 'c': 0.1, 'h': 0.001, 'y': 0.0001
        },
        'beta': {
            'wi': 8e-7, 'vi': 8e-7, 'wf': 8e-7, 'vf': 8e-7, 'wg': 8e-7, 'vg': 8e-7, 'wo': 8e-7, 'vo': 8e-7, 'wy': 8e-7
        }
    ...
    'YahooFinance': {
        'rho': {
            'i': 3., 'f': 3., 'g': 3., 'o': 3., 'c': 0.012, 'h': 0.0012, 'y': 0.000082
        },
        'beta': {
            'wi': 8e-8, 'vi': 8e-8, 'wf': 8e-8, 'vf': 8e-8, 'wg': 8e-8, 'vg': 8e-8, 'wo': 8e-8, 'vo': 8e-8, 'wy': 8e-8
        }
    },
    ...
    'HAR': {
        'rho': {
            'i': 1.5, 'f': 1.5, 'g': 1.5, 'o': 1.5, 'c': 0.006, 'h': 8e-05, 'y': 4e-06  # for hidden = 128, y < 4e-6
            # 'i': 1.0, 'f': 1.0, 'g': 1.0, 'o': 1.0, 'c': 0.007, 'h': 9e-05, 'y': 5e-06  # for hidden = 64
        },
        'beta': {
            'wi': 8e-7, 'vi': 8e-7, 'wf': 8e-7, 'vf': 8e-7, 'wg': 8e-7, 'vg': 8e-7, 'wo': 8e-7, 'vo': 8e-7, 'wy': 8e-7
        }
    ...
    'DNA1': {
        'rho': {
            'i': 1., 'f': 1., 'g': 1., 'o': 1., 'c': 0.001, 'h': 0.0002, 'y': 0.0004
        },
        'beta': {
